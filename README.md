...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eo-learn-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8651&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eo-learn-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eo-learn-core` can be installed with:

```
conda install eo-learn-core
```

It is possible to list all of the versions of `eo-learn-core` available on your platform with:
